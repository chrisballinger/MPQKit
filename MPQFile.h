...
*/
@property (nonatomic, readonly, copy) NSDictionary *fileInfo;
...
*/
@property (nonatomic, readonly) uint32_t offsetInFile;
...
@property (nonatomic, readonly) BOOL liveSectorChecksumValidatation;
...
*/
@property (nonatomic, readonly, copy) NSData *copyDataToEndOfFile;
...
*/
@property (nonatomic, getter=getDataToEndOfFile, readonly, copy) NSData *dataToEndOfFile;
